...
const LoginIconSolid = ({ viewBox, height, width, title, className, style, fill, ariaHidden, preserveAspectRatio, ariaDesc, }) => (
  <svg
    viewBox={viewBox}
    height={height}
    width={width}
  ...
  >
  <title aria-label={ariaDesc}>{title}</title>
